...
import OccupancyPie from '../utils/Pie';
...
const load = async () => {
  ...
  return (
    <Layout>
                ...
                <tbody>
                  {units.map((u) => (
                    <tr key={u.id}>
                      ...
                      <td className="text-slate-100">{money(u.rent_amount)}</td>
                      <td>
      ...
      <Card title="Occupancy snapshot" description="Live pie" className="lg:max-w-xl">
